    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              {user ? (
                <Button onClick={() => router.push('/dashboard')} size="sm" className="text-sm sm:text-base whitespace-nowrap">
                  Dashboard
                </Button>
              ) : (
                <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-20 -right-20 w-40 h-40 sm:w-80 sm:h-80 bg-primary-200 rounded-full blur-3xl opacity-20 animate-pulse"></div>
          <div className="absolute -bottom-20 -left-20 w-40 h-40 sm:w-80 sm:h-80 bg-primary-300 rounded-full blur-3xl opacity-20 animate-pulse delay-1000"></div>
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Left content */}
            <div className="space-y-4 sm:space-y-8 animate-fadeIn text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-primary-100 text-primary-700 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-semibold">
                ...
                <span className="hidden sm:inline">Solution digitale pour salons modernes</span>
                <span className="sm:hidden">Solution digitale</span>
              </div>
              
              <h1 className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-secondary-900 leading-tight">
              ...
              <p className="text-sm sm:text-lg lg:text-xl text-secondary-600 leading-relaxed px-2 sm:px-0">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-6 pt-4 sm:pt-8 border-t border-secondary-200">
                <div>
                  <div className="text-xl sm:text-3xl font-bold text-primary-500">2min</div>
                  <div className="text-xs sm:text-sm text-secondary-600">Installation</div>
                </div>
                <div>
                  <div className="text-xl sm:text-3xl font-bold text-primary-500">+40%</div>
                  <div className="text-xs sm:text-sm text-secondary-600">Clients satisfaits</div>
                </div>
                <div>
                  <div className="text-xl sm:text-3xl font-bold text-primary-500">24/7</div>
              ...
              <div className="relative z-10 space-y-4">
                ...
                <Card className="max-w-sm sm:max-w-md mx-auto" gradient>
                  <div className="space-y-3 sm:space-y-6">
                    <div className="flex items-center justify-between">
                      <h3 className="text-base sm:text-xl font-bold text-secondary-900">Salon Freddy</h3>
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-4">
                      <div className="bg-white/80 backdrop-blur p-2 sm:p-4 rounded-xl">
                        <Users className="w-5 h-5 sm:w-8 sm:h-8 text-primary-500 mb-1 sm:mb-2" />
                        <div className="text-lg sm:text-2xl font-bold text-secondary-900">3</div>
                        <div className="text-xs sm:text-sm text-secondary-600">En attente</div>
                      </div>
                      <div className="bg-white/80 backdrop-blur p-2 sm:p-4 rounded-xl">
                        <Clock className="w-5 h-5 sm:w-8 sm:h-8 text-primary-500 mb-1 sm:mb-2" />
                        <div className="text-lg sm:text-2xl font-bold text-secondary-900">35min</div>
      ...
      <section className="py-8 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-16">
            <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-secondary-900 mb-2 sm:mb-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 lg:gap-8">
            {features.map((feature, index) => (
              <Card key={index} hover className="group">
                <div className="mb-2 sm:mb-4 inline-flex p-2 sm:p-3 bg-primary-100 rounded-xl group-hover:bg-primary-500 transition-colors">
                  <feature.icon className="w-5 h-5 sm:w-8 sm:h-8 text-primary-500 group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-sm sm:text-lg lg:text-xl font-bold text-secondary-900 mb-1 sm:mb-2">
                  {feature.title}
                </h3>
                <p className="text-xs sm:text-base text-secondary-600 leading-relaxed">
                  {feature.description}
                </p>
              </Card>
            ))}
      ...
      <section className="py-8 sm:py-20 bg-gradient-to-br from-secondary-50 to-primary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-16">
            <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-secondary-900 mb-2 sm:mb-4">
              Comment ça marche ?
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <Card className="h-full text-center">
                  <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-br from-primary-500 to-primary-600 text-white rounded-full flex items-center justify-center text-base sm:text-xl font-bold mx-auto mb-2 sm:mb-4">
                    {index + 1}
                  </div>
                  <h3 className="text-sm sm:text-lg lg:text-xl font-bold text-secondary-900 mb-1 sm:mb-2">
                    {step.title}
      ...
      <section className="py-8 sm:py-20 bg-gradient-to-r from-primary-500 to-primary-600 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/pattern.svg')] opacity-10"></div>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-6">
            Prêt à moderniser votre salon ?
          </h2>
          <p className="text-sm sm:text-lg lg:text-xl text-primary-100 mb-4 sm:mb-8">
            Rejoignez les salons de coiffure qui ont choisi l&apos;innovation
          </p>
          <Link href="/register">
            <Button size="lg" variant="secondary" className="bg-white text-primary-600 hover:bg-primary-50 w-full sm:w-auto text-sm sm:text-base">
