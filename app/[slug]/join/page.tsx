    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full text-center animate-fadeIn">
          <div className="w-20 h-20 bg-gradient-to-br from-success to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-strong">
          ...
          <div className="p-6 bg-primary-50 rounded-xl mb-6">
            <p className="text-sm text-secondary-700 mb-4 font-semibold">
              📱 Que faire maintenant ?
            </p>
            <ul className="text-sm text-secondary-700 space-y-2 text-left">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <Card className="animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-4 bg-primary-50 rounded-lg border-2 border-primary-100">
